            ...
            while self.running:
                try:
                    ...
                    if msg_type == 'GLOBAL_POSITION_INT':
                        ...
                        if abs(msg.groundspeed - self._last_hud_summary[sysid][0]) > 0.5:
                            self._last_hud_summary[sysid] = (msg.groundspeed, self._last_hud_summary[sysid][1], self._last_hud_summary[sysid][2])
                            self.signals.hud_updated.emit(self.node_id, sysid, msg.groundspeed, -1.0, -1.0, "")
                        ...
                        self.signals.heartbeat_received.emit(self.node_id, sysid, True)
                        ...
                        if flight_mode == "UNKNOWN" or flight_mode == "":
                            ...
                            if mapping:
                                ...
                                if not self._modes_emitted[sysid]:
